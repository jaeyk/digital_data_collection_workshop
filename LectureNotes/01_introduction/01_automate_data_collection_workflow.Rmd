...
tibble("year" = pub_year:(len(hits)-1),
       "hits" = hits)
...
- If you scrape too much information from the platform too quickly, you will be prohibited using it for a while.

6. Scale up automation using `purrr::reduce()`

- For instance, you can scrape citation information from not one book but many books (a list of the lists).
