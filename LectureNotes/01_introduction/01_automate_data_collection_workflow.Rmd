...
- Any attempt to scrape content from Google's service may cause you to be suspended from using it. So, I wrote this tutorial only for the educational purpose, please don't do it.
...
6. If you want to reduce the listed items you scraped ... 
