...
- When a target file is too large (>10GB) and you need to do complex wrangling, you may want to take a divide, conquer, and reduce strategy as outlined below. (Social media data stored in JSON are usually quite large.)
