...
3. Process: 
    ...
    - Parsing (then doing modeling and visualizing) a sampled subset of this data on your local machine 
        - To be precise, this sample-model strategy is just one option to [deal with big data in R](https://rviews.rstudio.com/2019/07/17/3-big-data-strategies-for-r/).
...
- But what exactly is this target data?
    ...
    - When you do web scraping, you mostly deal with HTML (defines a structure of a website), CSS (its style), and JavaScript (its dynamic interactions).
    
    - When you deal with API, you mostly deal with either XML or JSON (major formats for storing and transporting data; they are light and flexible).
